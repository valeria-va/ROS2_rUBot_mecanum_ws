...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'config_arg'), glob(os.path.join('config_arg', '*launch.[py|xml]'))),
        (os.path.join('share', package_name, 'launch'), glob(os.path.join('launch', '*launch.[py|xml]'))),
        (os.path.join('share', package_name, 'models'), glob(os.path.join('models', '*launch.[py|xml]'))),
        (os.path.join('share', package_name, 'photos'), glob(os.path.join('photos', '*launch.[py|xml]'))),
    ],
