...
*/
#define FR_MOTOR 0 // Motor Front Dret
#define FL_MOTOR 1 // Motor Front Esquerre
#define BR_MOTOR 2 // Motor Darrere Dret
#define BL_MOTOR 3 // Motor Darrere Esquerre
...
int runCommand() {
  ...
  case READ_ENCODERS:
    ...
    Serial.print(" ");
    Serial.print(readEncoder(BACK_RIGHT));
    Serial.print(" ");
    Serial.println(readEncoder(BACK_LEFT));
    break;
   case RESET_ENCODERS:
    resetEncoders();
    resetPID();
  ...
  case MOTOR_SPEEDS:
    ...
    motorPID[FR_MOTOR].TargetTicksPerFrame = arg1;
    motorPID[FL_MOTOR].TargetTicksPerFrame = arg2;
    motorPID[BR_MOTOR].TargetTicksPerFrame = arg3;
    motorPID[BL_MOTOR].TargetTicksPerFrame = arg4;
    Serial.println("OK"); 
    break;
  case MOTOR_RAW_PWM:
    /* Reset the auto stop timer */
