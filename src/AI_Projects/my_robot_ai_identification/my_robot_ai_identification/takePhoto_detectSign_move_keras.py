...
class KerasImageClassifier(Node):
    def __init__(self):
        ...
        self.cmd_vel_pub = self.create_publisher(Twist, "/cmd_vel", 10) # Nuevo publisher para Twist

        # Capturas
        self.capture_enabled = True
        self.capture_dir = os.path.expanduser("~/ROS2_rUBot_mecanum_ws/src/Navigation_Projects/my_robot_ai_identification/pictures")
